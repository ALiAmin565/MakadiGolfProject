<x-layouts.app>
                    ...
                    <div class="">
                        <div class="team__slider-card__thumb" style="text-align: center;">
                            <img src="assetsFront/images/partners/{{ $partner->image }}" alt="Team"
                                style="height: 150px !important; width:150px !important ;object-fit:contain; ">
                        </div>
                    </div>
                @endforeach
            </div>
    ...
    <section class="section wow fadeInUp" data-wow-duration="0.4s">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    ...
                    <div class="faq-content">
                        @foreach ($faqs as $faq)
                            <div class="faq-question">
                                <input id="q{{ $loop->index + 1 }}" type="checkbox" class="panel">
                                <div class="plus">+</div>
                                <label for="q{{ $loop->index + 1 }}" class="panel-title">{{ $faq->question }}</label>
